...
define(function (require, exports, module) {
    ...
    var controlInput = module.exports = function (container, options,callbacks) {
    ...
    controlInput.prototype = {
        _init: function () {
            var newNode = document.createElement('div');
            newNode.innerHTML = String.format(this.html,{
        ...
        _bindEvent: function () {
            ...
            if(!this.options.supportTouch) {
                Util.dom.on(this.addDom, 'click', function () {
                    setValue(true);
                });
                Util.dom.on(this.reduceDom, 'click', function () {
                    setValue();
                });
            }else{
                ...
                var delRoll = function(){
                    Util.fn.delayRun("inputControl",function(){},0);
                };
                Util.dom.on(this.addDom, startEvt, function (e) {
                    e.preventDefault();
                    roll(true);
                });
                Util.dom.on(this.reduceDom, startEvt, function (e) {
                    e.preventDefault();
                    roll();
                });
                Util.dom.on(this.addDom, endEvt, function () {
                    delRoll();
                });
                Util.dom.on(this.reduceDom, endEvt, function () {
                    delRoll();
                });
            }
            var mouseEv = Util.ua.iOS ? "input" : "keyup";
            Util.dom.on(this.inputDom, mouseEv, function () {
            ...
            Util.dom.on(this.inputDom, 'blur', function () {
                var value = Util.fn.numberInputFix(this);
                self.setValue(value);
            });
            Util.dom.on(this.inputDom, 'focus', function () {
                self.callbacks&&self.callbacks.onFocus(this);
            });
        }
    };
});
